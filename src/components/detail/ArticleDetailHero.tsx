  ...
  return (
    <div className="relative bg-gradient-to-br from-primary via-primary to-[#000b2c] text-white">
      ...
      <div className="absolute inset-0 z-0 opacity-[0.07]">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="pattern-lines-dark" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse" patternTransform="rotate(45)"><line x1="0" y1="0" x2="0" y2="10" stroke="white" strokeWidth="1"/></pattern></defs><rect x="0" y="0" width="100%" height="100%" fill="url(#pattern-lines-dark)"></rect></svg>
      </div>

      {/* Content Container */}
      <div className="container mx-auto px-4 relative z-10">
        <div className="relative md:flex md:items-center min-h-[300px] md:min-h-[350px]">
          {/* --- Text Content (Left) --- */}
          ...
          <div
            className="
            relative md:absolute md:right-0 md:top-1/4 md:h-[60%] 
          ...
          >
            <div
              className="
                ...
                rounded-[4px] overflow-hidden shadow-2xl
